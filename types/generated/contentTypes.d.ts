...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    decription: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHeroBannerHeroBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    button1: Schema.Attribute.Blocks;
    button2: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTheDemoTheDemo extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'the-demos';
    singularName: 'the-demo';
  };
  options: {
    draftAndPublish: true;
  };
